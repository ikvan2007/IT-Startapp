...
//
// Unit-тесты для src/lib/xp.ts

import { calculateLevel, xpToNextLevel } from '@/lib/xp'
...
describe('XP utilities', () => {
  describe('calculateLevel', () => {
    ...
    it('не уходит в минус при 0', () => expect(calculateLevel(0)).toBeGreaterThanOrEqual(1))
