...
- Закрывает задачу: # (Например, INFRA-003)

## 🧪 Как проверял работу?
1. Запустить команду: `...`
2. Перейти по адресу: `...`

## 📸 Скриншоты интерфейса / Логи консоли
## ✅ Чек-лист разработчика:
- [ ] Код успешно запускается локально
- [ ] Нет конфликтов с главной веткой `main`
- [ ] Код отформатирован и не содержит лишнего мусора (console.log и т.д.)
